...
<div class="min-h-screen px-4">
    ...
    <div class="w-11/12 mx-auto">
        ...
        <p class="mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, illum. Consequuntur rem a officia ipsum rerum voluptas culpa cum harum!</p>
    </div>
    <div
    ...
    <div class="flex flex-col w-full px-4 py-5 lg:w-1/2">
        ...
        <div class="mt-5">
            <h1 class="text-3xl font-bold">Kosong</h1>
            <h1>Kosong</h2>

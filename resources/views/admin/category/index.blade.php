                        ...
                        <thead>
                            <tr>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span
                                        class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">Nama Kategori</span>
                                </th>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span
                                ...
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span
                                        class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">Terakhir Update</span>
                                </th>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span

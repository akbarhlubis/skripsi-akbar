...
<div class="mt-10 bg-gray-900">
    <div class="max-w-2xl py-10 mx-auto text-white">
        <div class="text-center">
            <h1 class="mb-3 text-3xl"> Install as <span class="px-2 font-black transition-all rounded-md hover:bg-white hover:text-black animate-pulse">PWA</span> </h1>
            <p> Stay up to date. All day, every day. </p>

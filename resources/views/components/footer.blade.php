...
<footer class="py-20 text-white px-14 footer bg-primary">
    <aside>
      ...
      <p class="mb-1  md:w-[40%] w-full">{{App\Models\Setting::findOrFail(1)->description}}</p>
      <div class="grid grid-flow-col gap-4">
        <a href="https://www.instagram.com/{{App\Models\Setting::findOrFail(1)->instagram}}/"><i class="bi bi-instagram"></i></a> 
    ...
    <nav class="flex gap-20">
      ...
      <div>
        ...
        <div class="grid grid-flow-row gap-4">
          ...
          <a href="https://wa.me/{{App\Models\Setting::findOrFail(1)->phone}}">{{App\Models\Setting::findOrFail(1)->phone}} (Chat Only)</a>
          <a href="mailto:{{App\Models\Setting::findOrFail(1)->email}}">{{App\Models\Setting::findOrFail(1)->email}}</a>
        </div>
      </div>
    </nav>
  </footer>